...
class UpdateQuantityUseCase:
    ...
    async def execute(self, usuario_id: str, item_id: int, nueva_cantidad: int) -> CarritoModel:
        # 1. Validamos que la cantidad sea lógica
        if nueva_cantidad <= 0:
            raise BadRequestError("La cantidad debe ser mayor a cero. Use eliminar para quitar el producto.")
