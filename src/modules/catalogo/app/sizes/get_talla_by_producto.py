...
class GetTallasByProducto:
    ...
    async def execute(self, producto_id: str) -> list[TallaModel]:
        return await self.repo.get_all_by_producto(producto_id)  # el repositorio hace el join y retorna las coincidencias
